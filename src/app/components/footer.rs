    ...
    view! {
        <footer class="app-footer">
            <div class="footer-left">
                ...
                " by " 
                <a href="https://github.com/hvlife-dev" target="_blank">"hvlife"</a>
            </div>
